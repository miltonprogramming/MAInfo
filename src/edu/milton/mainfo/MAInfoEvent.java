...
public class MAInfoEvent {
	...
	//full constructor
	public MAInfoEvent(String eventTitle, String eventDescription, Date eventDate, Time eventBeginTime, Time eventEndTime, boolean boarders, boolean clI, boolean clII, boolean clIII, boolean clIV, boolean dayStudents, String eventCategory) {
	...
	public MAInfoEvent(String eventTitle, String eventDescription, Date eventDate, Time eventBeginTime, Time eventEndTime) {
		this.eventTitle = eventTitle;
		this.eventDescription = eventDescription;
		this.eventDate = eventDate;
		this.eventBeginTime = eventBeginTime;
